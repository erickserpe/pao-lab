# 📋 Checklist de Funcionalidades e Indicadores de Desempenho (IDs)

> Acompanhamento dos Resultados de Aprendizagem (RA) e Indicadores de Desempenho (ID) da disciplina de Desenvolvimento Web — UTFPR.

---

## RA1 - Frameworks CSS e Layouts Responsivos

- [x] **ID 01:** Prototipação de telas mobile e desktop no Stitch/Figma.
